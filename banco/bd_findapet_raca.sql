...
CREATE TABLE `raca` (
  ...
  PRIMARY KEY (`rac_id`),
  KEY `fk_raca_especies1_idx` (`esp_id`),
  CONSTRAINT `fk_raca_especies1` FOREIGN KEY (`esp_id`) REFERENCES `especies` (`esp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-05-07  9:25:23
