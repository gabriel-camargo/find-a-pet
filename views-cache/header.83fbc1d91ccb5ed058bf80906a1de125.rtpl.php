...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light p-1">
    ...
    <div class="container-fluid">
      ...
      <a class="navbar-brand navbar-link" href="/find-a-pet/login/">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerPrincipal">
        ...
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item" id="meus_animais">
            <a class="nav-link navbar-link" href="/find-a-pet/animais"> Meus Animais </a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/find-a-pet/logout/"> Logout </a>
            </div>
          </li>
        </ul>
